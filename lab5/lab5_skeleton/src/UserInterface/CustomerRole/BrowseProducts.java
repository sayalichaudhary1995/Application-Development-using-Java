   ...
   DefaultTableModel model = (DefaultTableModel)orderTable.getModel();
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
            ...
            try
            {
                ...
                {  
                    JOptionPane.showMessageDialog(null, "sales price can not be less than the actual price");
                    return;
                }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        // TODO add your handling code here:
        int seletedRow=orderTable.getSelectedRow();
        if(seletedRow<0)
        {
             return;
        }
        OrderItem oi=(OrderItem)orderTable.getValueAt(seletedRow, 0);
        ...
        {
            JOptionPane.showMessageDialog(null, "Qty is more than availability");
            return;
        }
        else
        {
            if(newQty <= 0)
            {
            JOptionPane.showMessageDialog(null, "Qty can not be less than 0");
            return;
            }
    ...
    private void btnRemoveOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveOrderItemActionPerformed
        ...
        int oldQty=oi.getQuantity();
        int newOty=oldAvail+oldQty;
        oi.getProduct().setAvail(newOty);
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        ...
        OrderItem oi = (OrderItem)orderTable.getValueAt(row, 0);
        ViewOrderItemDetailJPanel voijp = new ViewOrderItemDetailJPanel(upc, oi);
        upc.add("ViewOrderItemDetailJPanel", voijp);
        CardLayout layout = (CardLayout) upc.getLayout();
        layout.next(upc);
